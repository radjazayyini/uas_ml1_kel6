...
col4.metric(
    "📈 Tren",
    "Stabil" if mean_forecast.diff().mean() < 1000 else "Meningkat"
)
...
ax.axvline(ts.index[-1], linestyle="--", linewidth=1, color="black")
...
ax.set_title("Forecast Jumlah Wisatawan")
ax.set_xlabel("Tahun")
...
kualitas = "baik" if accuracy > 85 else "perlu peningkatan"
...
st.markdown(
    ...
    **Rekomendasi:**  
    Model cocok untuk **perencanaan jangka pendek (≤ 1 tahun)**.  
    Untuk jangka panjang disarankan menggunakan **SARIMA**.
    """
)
